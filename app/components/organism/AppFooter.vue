...
const sponsorItems = [
  ...
  { path: '/assets/images/devoldere-advocaten.png', link: 'https://devoldere.be/', name: 'Devoldere Advocaten' },
  { path: '/assets/images/heyde-jelle.png', link: 'https://velit.be/', name: 'Heyde Jelle' },
  { path: '/assets/images/pijpaert.png', link: 'https://thierrypijpaert.be/', name: 'Pijpaert' },
  { path: '/assets/images/renovatie.png', link: 'https://www.goedonderjedak.be/', name: 'Renovatie' },
]
...
const contactLinks = [
  { text: 'Sportdreef 1B, 9890 Gavere', href: 'https://maps.app.goo.gl/naJyMZre6dtJk2hQ7', external: true },
