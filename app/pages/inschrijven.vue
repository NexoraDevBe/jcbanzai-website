...
const handleSubmit = async () => {
  ...
  if (email2.value) {
    const email2Validation = validateEmail(email2.value, "Tweede Email", {
      required: false,
    });
...
<template>
  <MoleculeConformationModal
    ...
    message="Er bestaat al een lid met dezelfde naam en geboortedatum. Ben je zeker dat je opnieuw wilt inschrijven?"
